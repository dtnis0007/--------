...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.img_add = tk.PhotoImage(file="C:\\Users\\mvide\\Downloads\\Итоговый\\add.png")
        ...
        self.img_upd = tk.PhotoImage(file="C:\\Users\\mvide\\Downloads\\Итоговый\\change.png")
        ...
        # Кнопка поиска
        self.img_search = tk.PhotoImage(file="C:\\Users\\mvide\\Downloads\\Итоговый\\search.png")
        ...
        # Кнопка обновления
        self.img_refresh = tk.PhotoImage(file="C:\\Users\\mvide\\Downloads\\Итоговый\\refresh.png")
